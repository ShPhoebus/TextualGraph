...
class LightGCN(nn.Module):
    ...
    def _init_weight(self, data_config):
        ...
        # 2. 如果有预训练嵌入,则更新对应位置
        pretrain_drug_emb = data_config.get('pretrain_drug_emb', None)
        pretrain_target_emb = data_config.get('pretrain_target_emb', None)
        drug_id_to_idx = data_config.get('drug_id_to_idx', {})
