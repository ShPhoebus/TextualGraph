...
if __name__ == '__main__':
    ...
    for epoch in range(args.epoch):
        ...
        while s + args.batch_size <= len(train_cf):
            ...
            # print("Type of batch_loss:", type(batch_loss))
            # print("Value of batch_loss:", batch_loss)
            ...
            loss += batch_loss
            # print("Type of accumulated loss:", type(loss))
            # print("Value of accumulated loss:", loss)
            s += args.batch_size
